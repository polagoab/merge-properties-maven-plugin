# Merge Properties Maven Plugin [![Build Status](https://travis-ci.org/polagoab/merge-properties-maven-plugin.svg?branch=master)](https://travis-ci.org/polagoab/merge-properties-maven-plugin)
